            ...
            <div className="max-w-6xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="relative" // O container pai precisa ser relative
                    >
                        {/* Moldura Decorativa - z-0 (atrás de tudo) */}
                        <div className="absolute -top-4 -left-4 w-full h-full border border-[#C5A059] z-0" />

                        {/* Container da Imagem - z-10 (no meio) */}
                        ...
                        {/* Card Flutuante - AGORA COM z-20 (na frente de tudo) */}
